...
CREATE TABLE `ORDER` (
    ...
    FOREIGN KEY (Customer_id) REFERENCES CUSTOMER(Id) ON DELETE CASCADE,
    FOREIGN KEY (Discount_code_id) REFERENCES DISCOUNT_CODE(Id) ON DELETE SET NULL
);
...
CREATE TABLE DISCOUNT_CODE_USAGE (
    ...
    Customer_id INT,
    Order_id INT,
    FOREIGN KEY (Discount_code_id) REFERENCES DISCOUNT_CODE(Id) ON DELETE CASCADE,
    FOREIGN KEY (Customer_id) REFERENCES CUSTOMER(Id) ON DELETE CASCADE,
    FOREIGN KEY (Order_id) REFERENCES `ORDER`(Id) ON DELETE CASCADE
);
...
CREATE TABLE ADMIN_ORDER_NOTIFICATION (
    Id INT AUTO_INCREMENT PRIMARY KEY,
    Order_id INT NOT NULL,
    Preview TEXT NOT NULL,
    Message TEXT NOT NULL,
...
FOR EACH ROW
BEGIN
    INSERT INTO BEST_SELLER (Book_id, Purchase_count)
