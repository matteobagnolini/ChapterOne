        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row" id="autore-<?php echo $author["Id"]; ?>" headers="id"><?php echo $author["Id"]; ?></th>
                        <td headers="nome"><?php echo $author["First_name"]; ?></td>
                        <td headers="cognome"><?php echo $author["Last_name"]; ?></td>
                        <td headers="azioni">
