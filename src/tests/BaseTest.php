...
abstract class BaseTest extends TestCase {
    ...
    protected function tearDown(): void {
        ...
        $this->db->db->query("DELETE FROM ORDER_NOTIFICATION");
        $this->db->db->query("DELETE FROM BEST_SELLER");
        ...
        $this->db->db->query("ALTER TABLE ORDER_NOTIFICATION AUTO_INCREMENT = 1");
        $this->db->db->query("ALTER TABLE BEST_SELLER AUTO_INCREMENT = 1");
